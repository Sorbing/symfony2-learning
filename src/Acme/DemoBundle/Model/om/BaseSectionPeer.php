...
use Acme\DemoBundle\Model\map\SectionTableMap;
...
abstract class BaseSectionPeer
{
    ...
    const OM_CLASS = 'Acme\\DemoBundle\\Model\\Section';
     ...
     * e.g. SectionPeer::$fieldNames[SectionPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Pid', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'pid', ),
        BasePeer::TYPE_COLNAME => array (SectionPeer::ID, SectionPeer::NAME, SectionPeer::PID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'PID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'pid', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. SectionPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Pid' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'pid' => 2, ),
        BasePeer::TYPE_COLNAME => array (SectionPeer::ID => 0, SectionPeer::NAME => 1, SectionPeer::PID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'PID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'pid' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        $toNames = SectionPeer::getFieldNames($toType);
        $key = isset(SectionPeer::$fieldKeys[$fromType][$name]) ? SectionPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(SectionPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, SectionPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return SectionPeer::$fieldNames[$type];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SectionPeer::PID);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(SectionPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(SectionPeer::DATABASE_NAME);
     ...
     *
     * @param      Section $obj A Section object.
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(SectionPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(SectionPeer::$instances[$key])) {
                return SectionPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (SectionPeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        SectionPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(SectionPeer::DATABASE_NAME)->getTable(SectionPeer::TABLE_NAME);
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(SectionPeer::DATABASE_NAME);
