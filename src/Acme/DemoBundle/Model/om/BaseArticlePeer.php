...
abstract class BaseArticlePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Description', 'Content', 'AuthorId', 'SectionId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'description', 'content', 'authorId', 'sectionId', ),
        BasePeer::TYPE_COLNAME => array (ArticlePeer::ID, ArticlePeer::TITLE, ArticlePeer::DESCRIPTION, ArticlePeer::CONTENT, ArticlePeer::AUTHOR_ID, ArticlePeer::SECTION_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'DESCRIPTION', 'CONTENT', 'AUTHOR_ID', 'SECTION_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'description', 'content', 'author_id', 'section_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Description' => 2, 'Content' => 3, 'AuthorId' => 4, 'SectionId' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'content' => 3, 'authorId' => 4, 'sectionId' => 5, ),
        BasePeer::TYPE_COLNAME => array (ArticlePeer::ID => 0, ArticlePeer::TITLE => 1, ArticlePeer::DESCRIPTION => 2, ArticlePeer::CONTENT => 3, ArticlePeer::AUTHOR_ID => 4, ArticlePeer::SECTION_ID => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'DESCRIPTION' => 2, 'CONTENT' => 3, 'AUTHOR_ID' => 4, 'SECTION_ID' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'description' => 2, 'content' => 3, 'author_id' => 4, 'section_id' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function doCountJoinAuthor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ArticlePeer::AUTHOR_ID, AuthorPeer::ID, $join_behavior);
    ...
    public static function doCountJoinSection(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ArticlePeer::SECTION_ID, SectionPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Article objects pre-filled with their Author objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAuthor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Article) to $obj2 (Author)
    ...
    /**
     * Selects a collection of Article objects pre-filled with their Section objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Article objects.
    ...
    public static function doSelectJoinSection(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Article) to $obj2 (Section)
                $obj2->addArticle($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        SectionPeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + SectionPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Article) to the collection in $obj2 (Author)
                $obj2->addArticle($obj1);
            } // if joined row not null

            // Add objects for joined Section rows

            $key3 = SectionPeer::getPrimaryKeyHashFromRow($row, $startcol3);
            if ($key3 !== null) {
                $obj3 = SectionPeer::getInstanceFromPool($key3);
                if (!$obj3) {
                    ...
                    SectionPeer::addInstanceToPool($obj3, $key3);
                } // if obj3 loaded

                // Add the $obj1 (Article) to the collection in $obj3 (Section)
    ...
    /**
     * Selects a collection of Article objects pre-filled with all related objects except Author.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptAuthor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = ArticlePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Article) to the collection in $obj2 (Section)
                $obj2->addArticle($obj1);
    ...
    /**
     * Selects a collection of Article objects pre-filled with all related objects except Section.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
